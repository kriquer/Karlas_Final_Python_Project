...
graveyard_deck = decks.Graveyard_Deck()
...
c = player.Player("Computer", c_hand)
c_hand = spanish_deck.deal(4) #deals 4 cards to computer
...
for i in range(1000):
    ...
    if p1_choice.upper() == "A":
        ...
        p1.points_hand(p1_hand)
        c.points_hand(c_hand)
        if p1.points_hand(p1_hand) < c.points_hand(c_hand):
